...
// Configuration
const apikey = 'ptla_1O3lNu0pnzGDxDRPf666WTpFvjm5tDTowMldalXYhyI';
const capikey = 'ptlc_hEa7MJAK6SX7HgUTtHPDcHbRxxRigfEnCUXsyiPx6i9';
const domain = 'https://panelbergaransi.fiffxxyzsrv.web.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '7803020824:AAFzHeKgT5ZU-XV9n9AmR4fiqVGH23FZJfw';
const adminTelegramId = '6257217768';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'admin' && password === 'admin') {
    res.json({ success: true, user: { username: 'Neodev', role: 'admin' } });
  } else {
